...
1. Existen poco más de tres horas y media de diferencia entre ambas máximas respectivamente (15horas aprox. en el caso de las mujeres y 12 en el caso de los hombres). Es el valor máx. por día laborable.

2. Los valores correspondientes al tiempo mínimo dedicado al trabajo doméstico no pago por varones y mujeres de 18 años o más es de 0, razón por la cual -a priori- pienso que existe una gran dispersión de los datos ponderados para esta variable con relación a su valor promedio.

3. El promedio de horas x día que varones y mujeres mayores de 18 años de CABA dedican al trabajo doméstico no remunerado refleja la desigualdad de género: las mujeres dedican un promedio de 3 horas aprox. y los varones poco menos de dos horas por día (1.8).
