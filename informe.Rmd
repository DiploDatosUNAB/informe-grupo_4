...
```{r}
#| fig.cap = "Promedio de horas que mujeres y varones de 18 o más dedican a trabajo doméstico no pago."
...
```{r}
#| fig.cap="Promedio de horas que mujeres y varones de 18 o más dedican a tareas de cuidados."
...
```{r}
#| fig.cap =""Promedio de horas que mujeres y varones de 18 o más dedican al trabajo pago"
uso_tiempo_2016|>
  filter(edad>=18)|>
  group_by(sexo)|>
...
#| fig.cap = "frecuencia de casos de mujeres de 18 años o más por intervalos de horas de trabajo doméstico no pago"
...
```{r}
#| fig.cap ="Nivel educativo de mujeres de 18 años o más de CABA por promedio de tiempo dedicado al trabajo pago"
